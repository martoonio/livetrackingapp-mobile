...
class LocationValidator {
  ...
  static Future<bool> _hasUnrealisticMovement(Position position) async {
    ...
    final distance = Geolocator.distanceBetween(_lastPosition!.latitude,
        _lastPosition!.longitude, position.latitude, position.longitude);

    final elapsedTimeSeconds =
    ...
    if (speed > MAX_REALISTIC_SPEED && distance > 100) {
      print(
          'Unrealistic movement: $speed m/s over $distance meters in $elapsedTimeSeconds seconds');
      return true;
    }
